...
const result = service.runEval(SCENARIO_ID, MODEL_ID);

const { scenario, model, results, summary } = result;
...
console.log(`  Grounding score        : ${(summary.groundingScore * 100).toFixed(0)}%`);
